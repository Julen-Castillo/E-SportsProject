...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
      jFondo.setBackground(new Color(5, 203, 235,255));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Mamecorp White.png"))); // NOI18N
        ...
        pFondoLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondologin (2).jpg"))); // NOI18N
        getContentPane().add(pFondoLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(-200, 0, 1340, 580));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("SDFDSF");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 120, 120, 60));
